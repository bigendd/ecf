...
public class TravellogController {
    ...
    @PostMapping
    public ResponseEntity<TravellogDtoResponse> createTravellog(@RequestBody TravellogDtoReceive dtoReceive) {
        TravellogDtoResponse created = travellogsService.create(dtoReceive);
